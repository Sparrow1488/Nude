...
namespace Nude.API.Migrations
{
    ...
    [Migration("20230506135835_0.0.13")]
    partial class _0013
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlacklistTag", b =>
                {
                    b.Property<int>("BlacklistsId")
                        .HasColumnType("integer")
                        .HasColumnName("blacklists_id");

                    b.Property<int>("TagsId")
                        .HasColumnType("integer")
                        .HasColumnName("tags_id");

                    b.HasKey("BlacklistsId", "TagsId")
                        .HasName("pk_blacklist_tag");

                    b.HasIndex("TagsId")
                        .HasDatabaseName("ix_blacklist_tag_tags_id");

                    b.ToTable("blacklist_tag", (string)null);
                });
            ...
            modelBuilder.Entity("Nude.API.Models.Blacklists.Blacklist", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Nude.API.Models.Users.User", b =>
                {
                    ...
                    b.HasIndex("BlacklistId")
                        .IsUnique()
                        .HasDatabaseName("ix_users_blacklist_id");
            ...
            modelBuilder.Entity("BlacklistTag", b =>
                {
                    b.HasOne("Nude.API.Models.Blacklists.Blacklist", null)
                        .WithMany()
                        .HasForeignKey("BlacklistsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_blacklist_tag_blacklists_blacklists_id");
                    ...
                    b.HasOne("Nude.API.Models.Tags.Tag", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_blacklist_tag_tags_tags_id");
                });
            ...
            modelBuilder.Entity("Nude.API.Models.Users.User", b =>
                {
                    b.HasOne("Nude.API.Models.Blacklists.Blacklist", "Blacklist")
                        .WithOne("User")
                        .HasForeignKey("Nude.API.Models.Users.User", "BlacklistId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_users_blacklists_blacklist_id");
