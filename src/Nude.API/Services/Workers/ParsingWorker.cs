...
//
// namespace Nude.API.Infrastructure.Services.Workers;
//
// public sealed class ContentTicketsWorker : IBackgroundWorker
// {
...
//
//         Ticket = await _context.ParsingTickets  <------------ GET WAITING METHOD
//             .Include(x => x.Meta)
//             .Include(x => x.Result)
